...
export default function Clubs6() {
  return (
    <svg
    ...
    >
      ...
      <rect
        ...
        stroke="black"
      />
      <use xlinkHref="#VC6" height="32" x="-100.4" y="-152.5" />
      <use xlinkHref="#SC6" height="26.769" x="-97.784" y="-115.5" />
      <use xlinkHref="#SC6" height="54" x="-72.167" y="-130.735" />
      <use xlinkHref="#SC6" height="54" x="18.167" y="-130.735" />
      <use xlinkHref="#SC6" height="54" x="-72.167" y="-27" />
      <use xlinkHref="#SC6" height="54" x="18.167" y="-27" />
