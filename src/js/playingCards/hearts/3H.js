...
export default function Hearts3() {
  return (
    <svg
    ...
    >
      ...
      <rect
        ...
        stroke="black"
      />
      <use xlinkHref="#VH3" height="32" x="-100.4" y="-152.5" />
      <use xlinkHref="#SH3" height="26.769" x="-97.784" y="-115.5" />
      <use xlinkHref="#SH3" height="54" x="-27" y="-130.667" />
      <use xlinkHref="#SH3" height="54" x="-27" y="-27" />
